        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h2 class="text-success">Dynamic Field</h2>
                </div>
                <div class="card-body">
    ...
    $(document).ready(function(){
        ...
        $('#add').click(function(){
            ...
            $('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added">' +
                '<td><input type="text" name="title[]" placeholder="Enter title" class="form-control name_list" value="'+title+'" /></td>' +
        ...
        $('#submit').click(function(){
            $.ajax({
                url:"{{ url('/add-remove-input-fields/store') }}",
                method:"POST",
                data:$('#add_name').serialize() , "_token": "{{csrf_token()}}",
                type:'json',
